...
public class PendulumRunner {
	...
	GravityConstant Earth = new GravityConstant(new Earth());	
	GravityConstant Jupiter = new GravityConstant(new Jupiter());
	...
	rp.setConstant(Earth);
	sp.setConstant(Earth);
	rpCoarse.setConstant(Earth);
	...
	for (int second = 1; second <= 20; second++) {
	    if(second == 10){
			rp.setConstant(Jupiter);
			sp.setConstant(Jupiter);
			rpCoarse.setConstant(Jupiter);
	    	System.out.println("Swtich to Jupiter");
	    }
