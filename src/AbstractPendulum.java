...
public abstract class AbstractPendulum {
    ...
    public GravityConstant g = new GravityConstant(new Earth());
	...
	if (!validGC (g.getGravitationalField()))
		throw new IllegalArgumentException ("invalid local gravitational field: " + g.getGravitationalField());
    }
    ...
    public void setConstant(GravityConstant newConstant){
    	g = newConstant;
    }
